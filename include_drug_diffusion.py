...
class DrugDeliverySimulator:
    def __init__(self):
        ...
        # 控制面板
        self.ax_control = self.fig.add_subplot(gs[0, 1], facecolor='#b2ebf2')
        self.ax_control.set_title('Simulation Controls', color='#01579b', fontsize=14, pad=10)
        self.ax_control.axis('off')
        
        # 分析面板
        self.ax_analysis = self.fig.add_subplot(gs[1, 1], facecolor='#b2ebf2')
        self.ax_analysis.set_title('Analysis & Results', color='#01579b', fontsize=14, pad=10)
        self.ax_analysis.axis('off')
        
        # 添加aptamer长度滑块
        slider_ax1 = plt.axes([0.55, 0.50, 0.35, 0.02], facecolor='#80deea')
        self.slider_length = Slider(slider_ax1, 'Aptamer Length (nm)', 5, 50, valinit=20, 
                                   color='#29b6f6', track_color='#b3e5fc')
        
        # 添加方向滑块
        slider_ax2 = plt.axes([0.55, 0.45, 0.35, 0.02], facecolor='#80deea')
        slider_ax3 = plt.axes([0.55, 0.40, 0.35, 0.02], facecolor='#80deea')
        slider_ax4 = plt.axes([0.55, 0.35, 0.35, 0.02], facecolor='#80deea')
        ...
        # 添加药物参数滑块
        slider_ax5 = plt.axes([0.55, 0.30, 0.35, 0.02], facecolor='#80deea')
        ...
        # 添加模式选择按钮
        mode_ax = plt.axes([0.45, 0.25, 0.2, 0.1], facecolor='#b2ebf2')
        ...
        # 添加穿膜按钮
        translocation_ax = plt.axes([0.65, button_y - 2*button_spacing, 0.2, button_height], facecolor='#7b1fa2')
        self.translocation_button = Button(translocation_ax, 'Simulate Delivery', color='#ba68c8', hovercolor='#e1bee7')
        
        # 添加药物递送按钮
        drug_ax = plt.axes([0.65, button_y - 3*button_spacing, 0.2, button_height], facecolor='#7e57c2')
        self.drug_button = Button(drug_ax, 'Start Drug Diffusion', color='#b39ddb', hovercolor='#d1c4e9')
